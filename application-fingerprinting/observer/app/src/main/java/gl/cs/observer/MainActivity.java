...
public class MainActivity extends AppCompatActivity {
    ...
    private final String dateStr = new SimpleDateFormat("yyyy-MM-dd",
    ...
    private final BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            textViewStatus.setText("Detected " + sensor + " at " + timestamp
                    + " using SENSOR_DELAY_" + delay + "\n");
            writeToFile(sensor, delay, timestamp);
            stopService();
        }
    };
    ...
    private void writeToFile(String sensor, String delay, String timestamp) {
        try {
            String filePath = dateStr + "_receiver.txt";
            ...
            outputStreamWriter.write(timestamp + ";" + dataID + ";" + sensor + ";" + delay + "\n");
